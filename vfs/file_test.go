...
func fileCreateLinks(t *testing.T, mode vfscommon.CacheMode, links bool) (r *fstest.Run, vfs *VFS, fh *File, item fstest.Item, lh *File, linkItem fstest.Item) {
	...
	*/
	...
	return r, vfs, node.(*File), file1, nil /*linkNode.(*File)*/, fstest.Item{} /*link1*/
}

func fileCreate(t *testing.T, mode vfscommon.CacheMode) (r *fstest.Run, vfs *VFS, fh *File, item fstest.Item) {
	r, vfs, fh, item, _, _ = fileCreateLinks(t, mode, false)
	return r, vfs, fh, item
}
...
func testFileSymlinks(t *testing.T, mode vfscommon.CacheMode, inCache bool, forceCache bool, links bool) {
	r, vfs, file, fileItem, _ /*link*/, _ /*linkItem*/ := fileCreateLinks(t, mode, links)
